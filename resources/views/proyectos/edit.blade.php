            ...
            <form action="{{route('proyectos.update', ['proyecto'=> $proyecto->id])}}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" id="nombre" name="nombre" value="{{old('nombre') ?? $proyecto->nombre}}" class="form-control border-0 shadow @error('nombre') is-invalid @enderror" placeholder="¿Cuál es el proyecto?">
                        @error('nombre')
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <textarea id="descripcion" name="descripcion" class="form-control border-0 shadow @error('descripcion') is-invalid @enderror" placeholder="Comentarios..." rows="5">{{ old('descripcion') ?? $proyecto->descripcion}}</textarea>
                        @error('descripcion')
                            <span class="d-block text-danger mt-2 font-weight-bold">{{ $message }}</span>
                        @enderror
                    </div>
